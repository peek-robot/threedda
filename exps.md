...
CUDA_VISIBLE_DEVICES=0 conda activate pr_3dda_robocsasa && python scripts/threedda/run_3dda.py --dataset /home/memmelma/Projects/tool_use/data/PnP/trajs_joint_s2r_0123.hdf5 --augment_pcd --augment_rgb --obs_noise_std 0.01 --num_epochs 1500 --task pick_and_place_robo --obs_path --obs_mask_w_path --fps_subsampling_factor 5 --history 1 --model_name_vlm vila_3b_path_mask_fast --server_ip_vlm http://0.0.0.0:8000 --mask_pixels 15 --obs_continuous_gripper --action_space abs_ee --obs_path_mask_noise_std 0.01 --update_every_timesteps_vlm 32 --seed 0 --resume --name ee_robo_3k

CUDA_VISIBLE_DEVICES=1 conda activate pr_3dda_robocsasa && python scripts/threedda/run_3dda.py --dataset /home/memmelma/Projects/tool_use/data/PnP/trajs_joint_s2r_0123.hdf5 --augment_pcd --augment_rgb --obs_noise_std 0.01 --num_epochs 1500 --task pick_and_place_robo --obs_path --obs_mask_w_path --fps_subsampling_factor 5 --history 1 --model_name_vlm vila_3b_path_mask_fast --server_ip_vlm http://0.0.0.0:8000 --mask_pixels 15 --obs_continuous_gripper --action_space abs_ee --obs_path_mask_noise_std 0.01 --update_every_timesteps_vlm 32 --seed 0 --obs_crop --resume --name ee_robo_3k_crop