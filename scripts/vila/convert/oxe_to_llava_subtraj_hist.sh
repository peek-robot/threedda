...
TARGET="path_mask_history" # -> droid doesn't have lang

DEBUG=false

# Script to be executed
SCRIPT_PATH="/lustre/fs12/portfolios/nvr/users/mmemmel/projects/vila/scripts_convert/convert_track_oxe_subtraj_hist.py"

# Base directory for log files
LOG_DIR="/lustre/fs12/portfolios/nvr/users/mmemmel/projects/vila/scripts_convert/slurm_logs_oxe_hist"
mkdir -p "$LOG_DIR"
